...
function WebhookExportCard() {
  ...
  return (
    <Card className="p-6" data-tour="institution-webhook-export">
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button
                ...
                size="sm"
                variant="outline"
                disabled={!exportAvailable || !endpoint?.active || busy}
...
export function ComplianceTab({
  ...
  return (
    <div className="g-agent g-agent--flip">
      {/* Independent columns prevent a tall audit trail from reserving an
          empty grid row beneath the shorter profile card. The DOM order also
          becomes the narrow-screen order: profile, webhook, audit, terms. */}
            ...
            >
              ...
              <label className="mt-3 block text-sm">
                ...
                <span className="mt-1 block text-[12px] leading-snug text-white/60">
                  Shown word-for-word in your clients&rsquo; &ldquo;Add money&rdquo; dialog. Leave
                  it empty and they are told to contact you for instructions instead.
                </span>
              </label>
              ...
              <fieldset className="m-0 mt-3 border-0 p-0">
                ...
                <span className="mt-1 block text-[12px] leading-snug text-white/60">
                  ...
                  it is made — a later change here never reprices a request already on your desk.
                  The flat fee is in the withdrawal&rsquo;s own currency; GCT is charged on your
                  fee.
                </span>
              </fieldset>
